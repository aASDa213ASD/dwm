...
static const char *fonts[]                = { "JetBrains Mono:size=16", "JetBrainsMono NFM:size=16" };
...
static const char *const autostart[] = {
	...
	"sh", "-c", "/home/aasda/.scripts/screenlayout/3440x1440p.sh", NULL,
	"sh", "-c", "feh --randomize --bg-fill /home/aasda/.wallpapers/*", NULL,
...
static Key keys[] = {
	...
	{ ALTKEY|ShiftMask,		XK_Shift_L,    spawn,		       SHCMD ("setxkbmap -query | grep -q 'layout: *us' && setxkbmap ru || (setxkbmap -quety | grep -q 'layout: *ru' && setxkbmap ua || setxkbmap us)")},
